...
<!-- Footer section -->
	<footer class="footer-section" style="top: 0;margin: 0;padding: 0;">
		<div class="container footer-top">
			<div class="row">
				<!-- widget -->
				<div class="col-sm-6 col-lg-3 footer-widget">
					<div class="about-widget">
						<img src="<?php echo base_url() ?>AIUB_whole_logo (1).png" alt="">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">ITLab Solutions Ltd.</a>
...
<script
  ...
  <script type="text/javascript" src="<?php echo base_url() ?>font_end/dist/js/jquery.bootstrap.newsbox.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url() ?>font_end/dist/js/flipclock.js"></script>

<script src="<?php echo base_url() ?>/style/headstyle.js"></script>
<script src="https://kit.fontawesome.com/eb2cb5a15f.js" crossorigin="anonymous"></script>
